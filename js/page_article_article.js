...
const articlesPagination = document.querySelector('.articlesPagination')
...
function pagination(jsonData, nowPage) {
  // 取得type="article"的資料
  articleInfo = jsonData.filter(i => i.type === "article");
  console.log(nowPage);
  // 取得全部資料長度
  const dataTotal = jsonData.filter(i => i.type === "article").length;
...
articlesPagination.addEventListener('click', switchPage);